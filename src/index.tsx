...
app.get('/api/stats', authMiddleware, async (c) => {
  const stats = await c.env.DB.prepare(`
    SELECT 
      ...
      SUM(CASE WHEN status = 'needs_testing' THEN 1 ELSE 0 END) as needs_testing_issues,
      SUM(CASE WHEN status = 'completed_testing' THEN 1 ELSE 0 END) as completed_testing_issues,
